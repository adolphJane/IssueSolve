...
from qa_manager.Tools import Html_Tools as To
...
def kwquery(query):
    ...
    # 抓取百度前10条的摘要
    soup_baidu = To.get_html_baidu('https://www.baidu.com/s?wd='+quote(query.encode('utf8')))
    ...
    #获取bing的摘要
    soup_bing = To.get_html_bing('https://www.bing.com/search?q='+quote(query.encode('utf8')))
    # 判断是否在Bing的知识图谱中
